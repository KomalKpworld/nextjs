...
import { Inter } from 'next/font/google'; import Navbar from '@/components/Navbar';
...
export default function Home() {
  return (
    <div>
      ...
      <div>
        <img src="/nawbar.jpg" width='100%' />
      </div>
      <div>
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Start Shopping</h1>
              <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquid placeat nulla saepe, cumque voluptatum possimus blanditiis voluptatibus reiciendis ad expedita ducimus suscipit debitis reprehenderit molestiae adipisci aliquam in doloremque quisquam!</p>
            </div>
